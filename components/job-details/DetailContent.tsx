...
const DetailContent = ({ data }: { data: JobDetailType }) => {
  return (
    <section className="sectionX pb-16 pt-6 md:py-12">
      <Wrapper className="rounded-md bg-White px-6 py-10 md:max-w-[730px] md:px-12 dark:bg-VeryDarkBlue">
        <article className="items-center justify-between md:flex">
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-xl font-bold text-VeryDarkBlue md:text-[28px] dark:text-White">
              {data.position}
            </h2>
