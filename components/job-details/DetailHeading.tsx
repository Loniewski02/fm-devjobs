...
const DetailHeading = ({
  ...
  return (
    <section className="sectionX -mt-[15px] md:-mt-10">
      <Wrapper className="relative rounded-md bg-White p-8 pt-12 md:flex md:max-w-[730px] md:rounded-tl-none md:p-0">
        <div
